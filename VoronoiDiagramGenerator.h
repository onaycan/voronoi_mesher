...
//		//cout<<"getNext returned the edge ("<<x1<<","<<y1<<") -> ("<<x2<<","<<y2<<")";
...
//		//cout<<"resetDelaunayEdgesIterator set iteratorDelaunayEdges = "<<iteratorDelaunayEdges;
	}
	...
	bool getNextDelaunay(float& x1, float& y1, float& x2, float& y2)
	{
		...
		{
//			//cout<<"iteratorDelaunayEdges = 0, returning false";
			return false;
		}
...
//		//cout<<"getNextDelaunay returned the edge ("<<x1<<","<<y1<<") -> ("<<x2<<","<<y2<<")";
